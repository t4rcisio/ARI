...
from pages import newIA_st1, newIA_st2
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:18pt; color:#ffffff;\">NEW IA MODEL</span></p></body></html>"))
    ...
    def __loadPages(self):
        ...
        self.newIA_st1.delete_button.setVisible(False)
    ...
    def __saveModel(self):
        ...
        if len(storage["CLASSES"]) >=1:
            ...
            self.store.alertTrigger({
                "MESSAGE": {
                    "MESSAGE": "THE MODEL MUST HAVE ONE CLASS",
                    "TITLE": "ERROR"}, 
                "OP": None})
    ...
    def __checkParamsPage1(self):
        ...
        modelList = self.store.modelParams()
        if modelList == None:
            modelList = {}

        modelName = str(self.newIA_st1.input_name.text()).strip().upper()
        ...
        if modelName == "":
            ...
            self.newIA_st1.label_2.setText('<html><head/><body><p><span style=" color:#ffffff;">MODEL NAME</span><span style=" color:#ff0000;"> *Already exists</span></p></body></html>')
            status = False
        else:
        ...
        if  res and status:
            self.label.setText("<html><head/><body><p><span style=\" font-size:18pt; color:#ffffff;\">NEW IA MODEL  | "+str(modelName)+"</span></p></body></html>")
